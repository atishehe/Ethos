        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">
              We value your opinion! Help us improve The Integral Cup by sharing
              your thoughts about the competition experience.
            </p>

            <div className="flex items-center justify-center gap-4 text-sm text-purple-300">
              <MathSymbol symbol="∫" size={16} />
              <span>
                Your feedback shapes the future of mathematical excellence
              </span>
              <MathSymbol symbol="∑" size={16} />
            </div>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm">
                Every piece of feedback helps us create a better competition
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm">
                We analyze all feedback to enhance problem difficulty, interface
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <p className="text-gray-300 text-sm">
                Your insights help shape the next generation of mathematical
                talent and competition excellence.
              </p>
            </div>
          </div>
        </div>
