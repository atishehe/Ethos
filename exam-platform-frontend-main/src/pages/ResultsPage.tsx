...
import { Trophy, Medal, Target, Zap, Star, Crown, Award, Flame } from 'lucide-react';

// Round label formatter with gaming terminology
const getRoundLabel = (round?: number) => {
  switch (round) {
    case 1: return { name: 'Preliminary Arena', icon: Target, color: 'text-blue-600' };
    case 2: return { name: 'Quarter Battle', icon: Zap, color: 'text-purple-600' };
    case 3: return { name: 'Semi Championship', icon: Medal, color: 'text-orange-600' };
    case 4: return { name: 'Grand Finale', icon: Crown, color: 'text-yellow-600' };
    default: return { name: `Arena ${round}`, icon: Target, color: 'text-gray-600' };
  }
};
            ...
            <TabsContent value="results" className="space-y-6">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 p-6 shadow-xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800">Competition Leaderboard</h2>
                  <IntegrationSymbol size={24} className="text-blue-500 animate-pulse" />
                </div>
            ...
            <TabsContent value="feedback" className="space-y-6">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200 p-6 shadow-xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <IntegrationSymbol size={24} className="text-green-500 animate-spin-slow" />
                </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-purple-50 to-blue-50 backdrop-blur-sm rounded-2xl border border-gray-200 p-6 shadow-xl">
            <div className="text-center">
              <div className="flex justify-center items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-800">Integration Mastery Challenge</h3>
                <IntegrationSymbol size={32} className="text-yellow-500" />
              </div>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Compete in mathematical integration challenges and prove your calculus prowess. 
                Every equation solved brings you closer to mathematical excellence!
              </p>
            </div>
          </div>
        </div>
