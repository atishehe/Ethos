  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      {[...Array(15)].map((_, i) => (
        <div
          key={i}
          className={`absolute text-6xl font-bold text-purple-200/20 animate-float-${
            (i % 4) + 1
          }`}
          style={{
...
const getRoundLabel = (round) => {
  switch (round) {
    case 1:
      return "INTEGRATION INITIATION";
    case 2:
      return "CALCULUS CHAMPIONSHIP";
    case 3:
      return "DERIVATIVE DUEL";
    case 4:
      return "ULTIMATE INTEGRATION";
    default:
      return `MATHEMATICAL CHALLENGE ${round}`;
  }
};
...
const ExamPage = () => {
  ...
  const { isExamEnded, setExamConfiguration, loadQuestions, isLoading } =
    useExam();
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        console.log(
          `Loaded questions for Round ${passedRoundNumber}, Group ${groupIndex}`
        );
      ...
      <div className="min-h-screen flex items-center justify-center py-16 bg-gradient-to-b from-gray-100 to-white relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          <div className="relative mb-8">
            ...
            <div className="absolute -top-4 -right-4 text-4xl animate-bounce text-purple-500">
              ∫
            </div>
            <div
              className="absolute -bottom-4 -left-4 text-4xl animate-bounce text-pink-500"
          ...
          <p className="text-2xl text-gray-600 mb-6">
            Prepare for Mathematical Combat!
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
            <div className="text-center py-20 relative">
              <div className="relative mb-12">
                <div className="w-32 h-32 mx-auto relative">
                  ...
                  <div
                    className="absolute inset-0 rounded-full border-4 border-pink-400 border-r-transparent animate-spin"
                    style={{ animationDirection: "reverse" }}
                  ></div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-5xl font-bold text-purple-500 animate-pulse">
                      ∫
                    </div>
                  </div>
                </div>
                <div className="absolute -top-4 -right-4 text-3xl text-pink-500 animate-bounce">
                  ∂
                </div>
                <div
                  className="absolute -bottom-4 -left-4 text-3xl text-indigo-500 animate-bounce"
                  style={{ animationDelay: "0.5s" }}
                >
                  ∑
                </div>
              ...
              <p className="text-2xl text-gray-600 mb-8">
                Preparing Your Mathematical Arsenal
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl border border-gray-200 shadow-2xl overflow-hidden relative">
              ...
              <div className="absolute top-4 right-4 text-6xl text-gray-100 font-bold">
                ∫
              </div>
              <ExamInterface
                group={group}
