...
import { Trophy, Users, Target, Zap, Crown, Star, Code, Activity, Calculator, BookOpen } from 'lucide-react';
...
const GameifiedGroupCard = ({ 
  ...
  return (
    ...
    >
      {/* Glow effect */}
      <div className={`absolute inset-0 rounded-2xl transition-all duration-1000 ${glowEffect && isSelected ? 'shadow-2xl shadow-purple-300/30' : ''}`} />
      
      <div className={`relative p-8 rounded-2xl bg-gradient-to-br text-gray-800 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border-2 ${
        isSelected 
        ...
        <div className="flex items-center justify-between mb-6 relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-gray-600 font-medium">{group.length} Members</div>
            </div>
          </div>
...
const GroupSelection = () => {
  ...
  const fallbackState = JSON.parse(localStorage.getItem(LOCAL_STORAGE_KEY) || '{}');
  ...
  const handleStartExam = () => {
    ...
    const updatedGroups = remainingGroups.filter((_, i) => i !== selectedGroupIndex);

    // Create students array with consistent group numbers for ExamContext
    const studentsWithCorrectGroupNumber = selectedGroup.group.map(student => ({
      name: student.name,
      roll: student.rollNo,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-100 to-blue-100 rounded-full border border-green-200 mb-4 backdrop-blur-sm">
              ...
              <span className="text-sm font-semibold text-green-700 uppercase tracking-wider">Round Complete</span>
            </div>
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
              All teams have completed their integration challenges successfully.
            </p>
    ...
    <section className="py-20 bg-gradient-to-b from-gray-100 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full border border-blue-200 mb-4 backdrop-blur-sm">
            <Calculator className="w-4 h-4 text-blue-600" />
            <span className="text-sm font-semibold text-blue-700 uppercase tracking-wider">Team Selection</span>
          </div>
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            Select a team to begin their integration challenge. Each team will compete in mathematical excellence.
          </p>
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-gray-200">
              ...
              <span className="text-gray-800 font-semibold">{remainingGroups.length}</span>
            </div>
          </div>
        </div>
          ...
          <div className="text-center">
            ...
            >
              <div className="flex items-center gap-2">
                <Zap className="w-5 h-5" />
                {selectedGroupIndex !== null ? 'Launch Challenge' : 'Select Team First'}
                <Star className="w-5 h-5" />
              </div>
            </Button>
          </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-4 px-6 py-3 bg-white/80 backdrop-blur-sm rounded-full border border-gray-200 shadow-lg">
            ...
            <span className="text-gray-500 text-sm">{remainingGroups.length} Teams Ready</span>
          </div>
        </div>
      </div>
    </section>
